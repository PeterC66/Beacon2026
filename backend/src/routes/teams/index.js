...
// (requireAuth + the `teams` feature gate), then mounts the concern-specific
// sub-routers. Order matters: the list router owns the literal `/download`
// path, so it is mounted before the CRUD router whose `/:id` would otherwise
// shadow it.
