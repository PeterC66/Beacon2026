      ...
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-lg shadow-md p-6 sm:p-8">
          ...
          <div className="bg-slate-50 rounded-md p-4 mb-6 text-sm space-y-1">
            <p>
              <span className="font-medium text-slate-700">Name:</span> {data.forenames}{' '}
              {data.surname}
            </p>
            <p>
            ...
            {data.partner2 && (
              <>
                <p>
                  ...
                  {data.partner2.forenames} {data.partner2.surname}
                </p>
                <p>
                  <span className="font-medium text-slate-700">Partner membership number:</span>{' '}
                  {data.partner2.membershipNumber}
                </p>
              </>
            )}
            <p>
              <span className="font-medium text-slate-700">Membership type:</span> {data.className}
              {data.partner2 ? ' (joint)' : ''}
            </p>
            {data.amount > 0 && (
              <p>
