// beacon2026/frontend/src/pages/finance/GiftAidLog.jsx
...
export default function GiftAidLog() {
  ...
  async function load() {
    ...
    setFilterErr(null);
    try {
      const data = await giftAidApi.log({
        from: fromDate,
        to: toDate,
          ...
          <>
            ...
            {entries.length === 0 ? (
              <p className="text-center text-slate-400 italic py-6">
                No Gift Aid consent changes in this date range.
              </p>
            ) : (
                  ...
                  <tbody>
                    {entries.map((e, i) => {
                      ...
                      const gaDate = detail.giftAidFrom
                        ...
                        : detail.previousGiftAidFrom
                          ? formatGaDate(detail.previousGiftAidFrom)
                          : '';
                      return (
                        <tr
                          key={e.id}
