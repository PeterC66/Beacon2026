...
const btnSmall =
  'border border-slate-300 text-slate-700 hover:bg-slate-50 rounded px-3 py-1 text-xs transition-colors';
const btnDanger =
                      ...
                      <td className="px-4 py-2.5 text-right whitespace-nowrap space-x-2">
                        ...
                        {editId === cat.id && (
                          <>
                            ...
                            <button onClick={() => setEditId(null)} className={btnSmall}>
                              Cancel
                            </button>
                          </>
                        )}
                        {canDelete && !cat.locked && editId !== cat.id && (
                          <button onClick={() => handleDelete(cat)} className={btnDanger}>
                            Delete
                          </button>
                        )}
                      </td>
