...
import { groups as groupsApi, requestBlob } from '../../lib/api.js';
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-3 items-end mb-4">
        <div>
          <label htmlFor="ledger-from-date" className={labelCls}>
            From
          </label>
          <input
            id="ledger-from-date"
        ...
        <div>
          <label htmlFor="ledger-to-date" className={labelCls}>
            To
          </label>
          <input
            id="ledger-to-date"
                  ...
                  <tr key={entry.id} className="bg-blue-50">
                    ...
                    >
                      <div className="flex flex-wrap gap-2 items-end">
                        <div>
                          <label htmlFor="ledger-edit-date" className={labelCls}>
                            Date
                          </label>
                          <input
                            id="ledger-edit-date"
                        ...
                        <div className="flex-1 min-w-32">
                          <label htmlFor="ledger-edit-payee" className={labelCls}>
                            Payee
                          </label>
                          <input
                            id="ledger-edit-payee"
                            name="payee"
                        ...
                        <div className="flex-1 min-w-40">
                          <label htmlFor="ledger-edit-detail" className={labelCls}>
                            Detail
                          </label>
                          <input
                            id="ledger-edit-detail"
                            name="detail"
                            className={`${inputCls} w-full`}
                        ...
                        <div className="w-24">
                          <label htmlFor="ledger-edit-money-in" className={labelCls}>
                            In (£)
                          </label>
                          <input
                            id="ledger-edit-money-in"
                            name="moneyIn"
                            type="number"
                            min="0"
                            step="0.01"
                        ...
                        <div className="w-24">
                          <label htmlFor="ledger-edit-money-out" className={labelCls}>
                            Out (£)
                          </label>
                          <input
                            id="ledger-edit-money-out"
                            name="moneyOut"
                            type="number"
                            min="0"
                            step="0.01"
      ...
      {canCreate && (
        <form onSubmit={handleAdd} className="mt-6 border-t border-slate-200 pt-4">
          ...
          <div className="flex flex-wrap gap-3 items-end">
            <div>
              <label htmlFor="ledger-add-date" className={labelCls}>
                Date <RequiredMark />
              </label>
              <input
                id="ledger-add-date"
            ...
            <div className="flex-1 min-w-32">
              <label htmlFor="ledger-add-payee" className={labelCls}>
                Payee
              </label>
              <input
                id="ledger-add-payee"
            ...
            <div className="flex-1 min-w-40">
              <label htmlFor="ledger-add-detail" className={labelCls}>
                Detail
              </label>
              <input
                id="ledger-add-detail"
                name="detail"
                className={`${inputCls} w-full`}
            ...
            <div className="w-24">
              <label htmlFor="ledger-add-money-in" className={labelCls}>
                In (£)
              </label>
              <input
                id="ledger-add-money-in"
                name="moneyIn"
                type="number"
                min="0"
                step="0.01"
            ...
            <div className="w-24">
              <label htmlFor="ledger-add-money-out" className={labelCls}>
                Out (£)
              </label>
              <input
                id="ledger-add-money-out"
                name="moneyOut"
                type="number"
                min="0"
                step="0.01"
