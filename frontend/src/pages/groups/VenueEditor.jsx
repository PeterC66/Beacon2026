...
export default function VenueEditor() {
  ...
  const actionBtnCls =
    'border border-blue-300 text-blue-600 hover:bg-blue-50 rounded px-3 py-2 text-sm transition-colors whitespace-nowrap';
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 text-sm cursor-pointer">
                <input
                  type="checkbox"
                  className={cbCls}
                  checked={form.privateAddress}
                  onChange={(e) => set('privateAddress', e.target.checked)}
                  disabled={!canChange}
                />
