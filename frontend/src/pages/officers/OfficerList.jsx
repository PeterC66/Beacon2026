// beacon2026/frontend/src/pages/officers/OfficerList.jsx
...
export default function OfficerList() {
  ...
  const inputCls =
    'w-full border border-slate-300 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500';
  const errCls =
    'w-full border border-red-400 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-400';

  function renderEditRow(key) {
    return (
                  ...
                  <tr className="bg-slate-50 border-b border-slate-200 text-left text-slate-600 italic font-normal">
                    <th className="px-3 py-2.5 font-normal text-center">
                      {can('email', 'send') && selectable.length > 0 && (
                        <button
                          onClick={toggleAll}
                          className="text-blue-600 hover:underline text-xs font-normal not-italic"
                        >
