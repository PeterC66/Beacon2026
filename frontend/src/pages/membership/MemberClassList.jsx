...
export default function MemberClassList() {
  ...
  const navLinks = [
    { label: 'Home', to: '/' },
    ...(can('member_classes', 'create')
      ? [{ label: 'Add Membership Class', to: '/membership/classes/new' }]
      : []),
  ];
                ...
                <thead>
                  <tr className="bg-slate-50 border-b border-slate-200 text-left text-slate-600 italic font-normal">
                    ...
                    <SortableHeader
                      ...
                      sortDir={sortDir}
                      onSort={onSort}
                      className="px-4 py-2.5 font-normal text-center"
                    />
                    <SortableHeader
                      col="is_joint"
                      label="Joint"
                    ...
                    <SortableHeader
                      ...
                      sortDir={sortDir}
                      onSort={onSort}
                      className="px-4 py-2.5 font-normal text-right"
                    />
                  ...
                  {sorted.map((mc, i) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-2.5 text-right">
                        {mc.fee != null ? Number(mc.fee).toFixed(2) : '—'}
                      </td>
                      <td className="px-4 py-2.5 text-right whitespace-nowrap">
                        {can('member_classes', 'change') && (
                          <a
                            ...
                            onClick={(e) => {
                              e.preventDefault();
                              navigate(`/membership/classes/${mc.id}`);
                            }}
