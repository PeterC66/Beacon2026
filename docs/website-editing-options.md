# Enabling beacon2026 users to edit the u3a website — options for management

## Why this note exists

We want members of the beacon2026 team to be able to make simple edits to our
...
- **beacon2026** has its own login system and a detailed permissions scheme
...
- A naming caveat: the word "SiteWorks" already appears inside beacon2026
  referring to a **scheduling platform** — unrelated to the WordPress theme.
  Any new feature in beacon2026 will need a distinct name (e.g. "Website
...
### Decision 1 — How does a beacon2026 user get into the website editor?
...
`docs/website-post-types-from-beacon2026.md` for a worked example of the
two-figure estimating basis.

| Option | What it feels like for the user | By hand | With Claude Code | What it gives up |
|---|---|---|---|---|
| **A. Link out to WordPress** | Click "Edit website" in beacon2026, arrive at the WordPress login page, sign in again. | Less than a day. | A few hours. | Two passwords. WordPress roles are managed inside WordPress, not beacon2026. |
| **B. beacon2026 creates WordPress accounts automatically** | User still logs into WordPress separately, but their account is created and kept up to date by beacon2026 when their beacon2026 role changes. | Roughly one week. | 2–3 days. | Still two passwords, but we no longer have to remember to update WordPress when someone joins or leaves. |
| **C. Single sign-on** | User clicks "Edit website" and is logged straight into WordPress with their beacon2026 identity. | Two to three weeks (small custom WordPress plugin plus work in beacon2026). | 1–1½ weeks. | Ongoing responsibility to maintain that plugin across WordPress upgrades. |
| **D. Editor built inside beacon2026** | The user never leaves beacon2026; a small editor inside beacon2026 lets them change specific website content. | Four to eight weeks, depending on scope. | 2–4 weeks. See `docs/website-post-types-from-beacon2026.md` for the specific case of the four SiteWorks structured post-types (`u3a_group`, `u3a_event`, `u3a_venue`, `u3a_contact`). | We are reinventing part of WordPress. Only simple edits are practical; complex layouts will still need WordPress. |
...
exist in WordPress and do not need beacon2026 involvement — they should stay
...
## What would change in beacon2026 under the recommendation

- A new permission named **Website editing** that controls whether a user
  sees the "Edit website" link in beacon2026. This fits into the existing
  beacon2026 permissions scheme and can be granted to any role.
...
- A short note in the beacon2026 user guide explaining that WordPress role
...
beacon2026 and how much we are willing to invest up front. The recommendation
