...
|--------|----------------|
| **Membership** | Member records, renewals, non-renewals, membership cards, statistics, address exports |
| **Groups** | Interest groups, venues, faculties (subject categories), the calendar |
| **Finance** | Financial ledger, transactions, transfers, credit batches, reconciliation, statements, Gift Aid |
| **Emails & Letters** | Composing and sending emails, standard messages, email delivery tracking, composing letters |
| **Online Services** | Online joining, the members portal, online renewals |
| **Set-Up** | System settings, system users, roles and privileges, finance accounts and categories, membership classes, custom fields, polls |
| **Miscellaneous** | Personal preferences, audit log, u3a officers, data export and backup, utilities |

Each of these is covered in detail in later sections of this guide.
