...
|------|-------------|--------|
| `ImprovementPlan.md` | The consolidated review + the numbered "chunk" work plan that drove the June 2026 improvements | All 12 chunks complete |
| `CODEBASE-RECOMMENDATIONS.md` | Pure code-rationalisation findings (R1–R12) | All addressed |
| `SECURITY-REVIEW.md` | The original security review and its findings | All findings fixed or accepted |
