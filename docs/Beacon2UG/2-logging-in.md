...
- **Password** [D] -- your password. **Passwords are case sensitive**, so
  `MyPassword1` and `mypassword1` are treated as different passwords.

Press the **Enter** button [E] to log in.

> **Tip:** You can toggle the password visibility using the eye icon to the
> right of the password field, which can help you check for typos.
...
Below the login form there is a link: **Forgotten your username or password?
Click here.** [F]. This opens an inline recovery section on the same page.

> **Note:** Site Administrators cannot use the self-service recovery flow for
> security reasons. If you are a Site Administrator, you will need to contact
> the Beacon support team.

### Step 1 -- Identify yourself

![Recovery form -- identify yourself](images/login-recovery-identify.png)
